    ...
    <div className='w-full h-[295rem]'>
      ...
      <div className=' w-[71.63rem] mx-auto flex flex-col justify-start mt-[3rem]'>
        ...
        <div className='  flex flex-col justify-center   gap-2 mt-[3rem]'>
          <h4 className='text-[1.5rem] font-medium '>AI Productivity for All Employees</h4>
          <h5 className='text-[0.875rem] font-normal  w-[61rem] '>Provide your teams with practical AI techniques that enhance productivity across writing, communication, presentations, research, brainstorming, and decision-making processes. Your employees will learn to leverage AI tools that streamline workflows and accelerate results, enabling them to work smarter and produce higher-quality output while strengthening your organization’s competitive advantage.</h5>
        ...
        <div >
          <div className='w-[71.871rem]  flex flex-col justify-center item-start  gap-2 mt-[3rem]'>
            ...
            <h5 className='text-[0.875rem] font-normal  '>Any employee who is interested in improving their communication, presentation, time management, and project management skills. This learning path is suitable for employees across various industries and roles.</h5>
          </div>

          <div className='w-[50.871rem]  flex flex-col  gap-2 mt-[3rem]'>
            <h4 className='text-[1rem] font-medium '>Learning objectives:</h4>
            <div className=''>
              <li className='text-[0.875rem] font-normal  '>Enhance communication skills by using AI writing assistants to create compelling and professional written content.</li>
              <li className='text-[0.875rem] font-normal '>Understand how to use AI tools to automate tasks and streamline workflows.</li>
              <li className='text-[0.875rem] font-normal '>Enhance time management skills to prioritize tasks and eliminate distractions.</li>
              <li className='text-[0.875rem] font-normal  '>Develop project management skills to plan, allocate resources, and track progress..</li>
