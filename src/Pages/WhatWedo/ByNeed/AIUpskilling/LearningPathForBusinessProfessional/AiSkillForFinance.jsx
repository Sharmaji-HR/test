    ...
    <div className='w-full h-[295rem]'>
      ...
      <div className=' w-[71.63rem] mx-auto flex flex-col justify-start mt-[3rem]'>
        ...
        <div className='  flex flex-col justify-center   gap-2 mt-[3rem]'>
          <h4 className='text-[1.5rem] font-medium '>AI Skills for Finance Professionals</h4>
          <h5 className='text-[0.875rem] font-normal  w-[61rem] '>This learning path is designed for Finance Professionals who want to unlock new levels of efficiency, insight, and impact using AI.</h5>
        ...
        <div >
          <div className='w-[71.871rem]  flex flex-col justify-center item-start  gap-2 mt-[3rem]'>
            ...
            <h5 className='text-[0.875rem] font-normal  '>Finance professionals</h5>
          </div>

          <div className='w-[50.871rem]  flex flex-col  gap-2 mt-[3rem]'>
            <h4 className='text-[1rem] font-medium '>Learning objectives:</h4>
            <div className=''>
              <li className='text-[0.875rem] font-normal  '>Discover time-saving hacks, automation tools, and productivity frameworks tailored to the finance world.</li>
              <li className='text-[0.875rem] font-normal '>Learn how to create effective prompts to unlock crucial accounting information, gain a deeper understanding of financial statements, and make data-driven decisions.</li>
              <li className='text-[0.875rem] font-normal '>Craft prompts for insightful financial analysis, identifying trends, uncovering risks and opportunities, and making informed predictions.</li>
              <li className='text-[0.875rem] font-normal  '>Use AI-powered prompts for effective communication and collaboration with business partners, fostering understanding and driving mutual success.</li>
              <li className='text-[0.875rem] font-normal  '>Develop risk management skills through AI-powered prompts, proactively identify potential issues, and implement effective mitigation strategies.</li>
...
export default AiSkillForFinance;
