...
const tabs = [
  ...
  'Performance reviews',
  'Unbiased policy writing',
  

];


const AiSkillForHuman = () => {
  return (
    <div className='w-full h-[295rem]'>
      ...
      <div className=' w-[71.63rem] mx-auto flex flex-col justify-start mt-[3rem]'>
        ...
        <div className='  flex flex-col justify-center   gap-2 mt-[3rem]'>
          <h4 className='text-[1.5rem] font-medium '>AI Skills for Human Resources Professionals</h4>
          <h5 className='text-[0.875rem] font-normal  w-[61rem] '>This learning path is designed for Human Resources Professionals to unlock the power of AI in building a thriving workforce.</h5>
        ...
        <div >
          <div className='w-[71.871rem]  flex flex-col justify-center item-start  gap-2 mt-[3rem]'>
            ...
            <h5 className='text-[0.875rem] font-normal  '>HR Professionals</h5>
          </div>

          <div className='w-[50.871rem]  flex flex-col  gap-2 mt-[3rem]'>
            <h4 className='text-[1rem] font-medium '>Learning objectives:</h4>
            <div className=''>
              <li className='text-[0.875rem] font-normal  '>Craft AI-powered questions that uncover ideal candidates’ true potential, eliminate bias, pinpoint key skills, and make every interview count.</li>
              <li className='text-[0.875rem] font-normal '>Summarize articles and reports with AI in seconds, stay informed on HR trends, and gain actionable insights for your team.</li>
              <li className='text-[0.875rem] font-normal '>Build individualized development plans with AI assistance, guide employees towards fulfilling careers, and unlock their full potential.</li>
              <li className='text-[0.875rem] font-normal  '>Streamline reviews, gain data-driven insights, and provide fair, transparent feedback for employee growth and development.</li>
              <li className='text-[0.875rem] font-normal  '>Write clear, inclusive policies with the help of AI, ensure compliance, and foster a fair and equitable workplace for all.</li>
...
export default AiSkillForHuman;
